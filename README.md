...
- When you have completed the assignment, you need to push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/8f56ff57-bf17-4d82-bbe2-febcafa611a0).
...
1. Please add NEXT_PUBLIC_API_URL='https://equalexperts.github.io/' in a .env file.

2. **Specific Use Cases:** 40% of tests were generated via AI tools, responsive fixes were done
3. **Percentage of Code Generated by AI:** 20%
4. **How AI-Generated Code Was Reviewed:** Since 40% tests were generated by AI, reviewed the test cases and ran it manually to test the results. / Responisve fixes were tested by manually testing on different viewports so that the responsive requirements were met.
