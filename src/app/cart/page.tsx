    ...
    if (cart.length === 0) {
        return (
            <main className="container mx-auto px-4 py-16 flex flex-col items-center justify-center">
                ...
                <Link href="/">
                    <Button className="text-lg px-8 py-2">
                        Start Shopping
                    </Button>
                </Link>
            </main>
        ...
        <main className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    {cart.map((item) => (
                        <div key={item.product.id} className="flex flex-col sm:flex-row gap-6 p-6 border rounded-lg bg-white ">
                            ...
                            <div className="flex flex-col grow justify-between gap-4">
                                <div className="flex justify-between items-start gap-4">
                                    <div>
                                        <h3 className="text-lg font-semibold line-clamp-2" title={item.product.title}>
                                            {item.product.title}
                                        </h3>
